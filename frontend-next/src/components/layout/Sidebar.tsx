...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col w-[220px] fixed inset-y-0 left-0 bg-[#111] border-r border-[#1a1a1a] px-3 py-6 z-30">
      <div className="px-3 mb-8">
        <span className="text-xl font-extrabold tracking-tight text-gold">gastos</span>
        <p className="text-[10px] text-[#555] uppercase tracking-[0.2em] mt-0.5">smart tracker</p>
      </div>
